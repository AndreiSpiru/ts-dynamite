    ...
    makeMove(gamestate: Gamestate): BotSelection {
        ...
        if(this.roundsPlayed > 0){
            ...
            if(lastRound.p1 == 'D' && lastRound.p2 == 'W'){
                this.dynamiteOnNumberDraws = getRandomInt(3) + 1
            }
        ...
        if((this.roundsPlayed > 300 || this.myDynamites - this.enemyDynamites > 50) && this.myDynamites > 0){
        ...
        if((this.consecutiveDraws > this.enemyLastDynamitedOn && this.enemyLastDynamitedOn > 0) || this.consecutiveDraws > this.dynamiteOnNumberDraws){
